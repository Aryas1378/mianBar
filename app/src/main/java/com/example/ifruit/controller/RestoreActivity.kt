...
class RestoreActivity(context: Context)  {

        var dbHandler = DataBaseHelper(context)
        fun createRestore() {
            try {
                val userFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/user.csv").readLines() as MutableList<String>
                val debtFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/debt.csv").readLines() as MutableList<String>
                val costFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/cost.csv").readLines() as MutableList<String>
                val contractFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/contract.csv").readLines() as MutableList<String>
                val contactFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/contact.csv").readLines() as MutableList<String>
                val employeeFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/employee.csv").readLines() as MutableList<String>
                val salaryFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/salary.csv").readLines() as MutableList<String>
                val fruitFileRead: MutableList<String> =
                    File("data/data/com.example.ifruit/files/fruit.csv").readLines() as MutableList<String>
                var counter = 0
